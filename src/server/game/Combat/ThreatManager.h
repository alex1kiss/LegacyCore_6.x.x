...
struct TRINITY_GAME_API ThreatCalcHelper
{
...
//==============================================================
class TRINITY_GAME_API HostileReference : public Reference<Unit, ThreatManager>
{
    public:
...
class TRINITY_GAME_API ThreatContainer
{
...
class TRINITY_GAME_API ThreatManager
{
    public:
