...
struct TRINITY_GAME_API LfgLockInfoData
{
...
TRINITY_GAME_API std::string ConcatenateDungeons(LfgDungeonSet const& dungeons);
TRINITY_GAME_API std::string GetRolesString(uint8 roles);
TRINITY_GAME_API std::string GetStateString(LfgState state);
