...
namespace Trinity
{
    struct TRINITY_GAME_API VisibleNotifier
    {
        Player &i_player;
        UpdateData i_data;
    ...
    struct TRINITY_GAME_API PlayerRelocationNotifier : public VisibleNotifier
    {
    ...
    struct TRINITY_GAME_API CreatureRelocationNotifier
    {
        Creature &i_creature;
    ...
    struct TRINITY_GAME_API DelayedUnitRelocation
    {
        Map &i_map;
        Cell &cell;
        CellCoord &p;
    ...
    struct TRINITY_GAME_API AIRelocationNotifier
    {
        Unit &i_unit;
        bool isCreature;
    ...
    struct TRINITY_GAME_API MessageDistDeliverer
    {
    ...
    class TRINITY_GAME_API AnyDeadUnitObjectInRangeCheck
    {
        public:
    ...
    class TRINITY_GAME_API AnyDeadUnitSpellTargetInRangeCheck : public AnyDeadUnitObjectInRangeCheck
    {
        public:
