...
namespace Movement
{
    ...
    TRINITY_GAME_API extern float gravity;
    TRINITY_GAME_API extern UInt32Counter splineIdGen;
    TRINITY_GAME_API extern std::string MovementFlags_ToString(uint32 flags);
    TRINITY_GAME_API extern std::string MovementFlagsExtra_ToString(uint32 flags);
}
