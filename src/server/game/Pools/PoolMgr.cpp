...
template TRINITY_GAME_API bool ActivePoolData::IsActiveObject<Creature>(uint64) const;
template TRINITY_GAME_API bool ActivePoolData::IsActiveObject<GameObject>(uint64) const;
template TRINITY_GAME_API bool ActivePoolData::IsActiveObject<Pool>(uint64) const;
template TRINITY_GAME_API bool ActivePoolData::IsActiveObject<Quest>(uint64) const;
