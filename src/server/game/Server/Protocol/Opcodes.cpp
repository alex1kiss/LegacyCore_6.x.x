...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status, con) \
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PANDAREN_CHOOSE_FACTION,                 STATUS_NEVER,        CONNECTION_TYPE_REALM);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PANDAREN_FACTION_CHOSEN,                 STATUS_NEVER,        CONNECTION_TYPE_REALM);
