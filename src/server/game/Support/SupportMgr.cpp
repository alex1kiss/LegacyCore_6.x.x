...
template TRINITY_GAME_API BugTicket* SupportMgr::GetTicket<BugTicket>(uint32);
template TRINITY_GAME_API ComplaintTicket* SupportMgr::GetTicket<ComplaintTicket>(uint32);
template TRINITY_GAME_API SuggestionTicket* SupportMgr::GetTicket<SuggestionTicket>(uint32);
...
template TRINITY_GAME_API uint32 SupportMgr::GetOpenTicketCount<BugTicket>() const;
template TRINITY_GAME_API uint32 SupportMgr::GetOpenTicketCount<ComplaintTicket>() const;
template TRINITY_GAME_API uint32 SupportMgr::GetOpenTicketCount<SuggestionTicket>() const;
...
template TRINITY_GAME_API void SupportMgr::RemoveTicket<BugTicket>(uint32);
template TRINITY_GAME_API void SupportMgr::RemoveTicket<ComplaintTicket>(uint32);
template TRINITY_GAME_API void SupportMgr::RemoveTicket<SuggestionTicket>(uint32);
...
template TRINITY_GAME_API void SupportMgr::CloseTicket<BugTicket>(uint32, ObjectGuid);
template TRINITY_GAME_API void SupportMgr::CloseTicket<ComplaintTicket>(uint32, ObjectGuid);
template TRINITY_GAME_API void SupportMgr::CloseTicket<SuggestionTicket>(uint32, ObjectGuid);
...
template TRINITY_GAME_API void SupportMgr::ResetTickets<BugTicket>();
template TRINITY_GAME_API void SupportMgr::ResetTickets<ComplaintTicket>();
template TRINITY_GAME_API void SupportMgr::ResetTickets<SuggestionTicket>();
...
template TRINITY_GAME_API void SupportMgr::ShowList<BugTicket>(ChatHandler&) const;
template TRINITY_GAME_API void SupportMgr::ShowList<ComplaintTicket>(ChatHandler&) const;
template TRINITY_GAME_API void SupportMgr::ShowList<SuggestionTicket>(ChatHandler&) const;
...
template TRINITY_GAME_API void SupportMgr::ShowClosedList<BugTicket>(ChatHandler&) const;
template TRINITY_GAME_API void SupportMgr::ShowClosedList<ComplaintTicket>(ChatHandler&) const;
template TRINITY_GAME_API void SupportMgr::ShowClosedList<SuggestionTicket>(ChatHandler&) const;
