...
#  define TRINITY_SCRIPT_API TRINITY_API_EXPORT
extern "C" {

/// Exposed in script modules to return the script module revision hash.
TRINITY_SCRIPT_API char const* GetScriptModuleRevisionHash()
{
    return _HASH;
}
...
TRINITY_SCRIPT_API char const* GetScriptModule()
{
    return "@SCRIPT_PROJECT@";
}

#else
#  define TRINITY_SCRIPT_API
#endif

/// Exposed in script modules to register all scripts to the ScriptMgr.
TRINITY_SCRIPT_API void AddScripts()
{
@TRINITY_SCRIPTS_INVOKE@}

/// Exposed in script modules to get the build directive of the module.
TRINITY_SCRIPT_API char const* GetBuildDirective()
{
